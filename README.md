...
Sessions are simple way to store data for individual users against a unique session ID

1. What does bcrypt do to help us store passwords in a secure manner.

It hashes passwords to keep everything secure from hackers.
1. What does bcrypt do to slow down attackers?

It continually hashes the password so the hacker can never get your original password. 
